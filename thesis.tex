...
\advisor[major]{김 원 화}{Won Hwa Kim}{signed}
%
...
\begin{document}
    ...
    \includepdf[pages={1},scale=1.0,offset=-0.cm 0cm]{advisor_sign.pdf}
    \includepdf[pages={1},scale=1.0,offset=-0.1cm 0cm]{signed_com.pdf}
...
\input{introduction_paraphrased.tex}

\chapter{Background}
% \input{background.tex}
\input{background_paraphrased.tex}

\chapter{Method}
% \input{method.tex}
\input{method_paraphrased.tex}

\chapter{Related Works}
% \input{relatedworks.tex}
\input{relatedworks_parapharsed.tex}

\chapter{Experiment}
% \input{experiment.tex}
\input{experiment_paraphrased.tex}

\chapter{Conclusion}
% \input{conclusion.tex}
\input{conclusion_paraphrased.tex}
